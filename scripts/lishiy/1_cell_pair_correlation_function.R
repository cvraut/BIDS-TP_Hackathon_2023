...
source("BIDS-TP_Hackathon_2023/scripts/compute_spatial_features.R")

setwd("/nfs/corenfs/INTMED-Speliotes-data/Projects/UK_ATLAS/IndivProj/craut/BIDS-2023-hackathon/BIDS-TP_Hackathon_2023/data")

cell_clusters <-arrow::read_parquet(
  file = "cell_clusters.parquet")


cell_features_TS2PL1 <- arrow::read_parquet(
  file = "TS2PL1_Cell_MasterDataTable-001.parquet") |>
...
ggplot2::ggsave(
  filename = "/nfs/corenfs/INTMED-Speliotes-data/Projects/UK_ATLAS/IndivProj/craut/BIDS-2023-hackathon/BIDS-TP_Hackathon_2023/product/pair_correlation_function_lishiy.pdf",
  plot = plot,
  width = 8,
  height = 4)
